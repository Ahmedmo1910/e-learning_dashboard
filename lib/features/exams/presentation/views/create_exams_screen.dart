...
// import 'package:teachers_dashboard/features/exams/data/exam_api.dart';
...
//   const CreateExamScreen({super.key, required this.teacherSubjectLessonId});

//   Future<String?> _getToken() async {
//     return await ApiPrefHelper.getToken();
//   }
...
//                               children: [
//                                 const Text("Date", style: AppTextStyles.semiBold16),
//                                 SizedBox(width: 150),
//                                 const Text("Duration", style: AppTextStyles.semiBold16),
//                               ],
//                             ),

//                             ExamDateDurationField(
...
import 'package:teachers_dashboard/features/exams/presentation/cubit/cubit/exam_cubit.dart';
import 'package:teachers_dashboard/core/services/api_pref_helper.dart';
import 'package:teachers_dashboard/features/exams/presentation/views/widgets/create_exam_content.dart';
class CreateExamScreen extends StatelessWidget {
  final String teacherSubjectLessonId;
